...
//mengecek apakah register udah di pencet apa belum
if(isset($_POST['register'])){
    ...
    /*
    KENAPA HARUS DIFILTER? biar ngga kena Serangan XSS
    <script>alert("HELLO");</script>

    Kenapa password tidak di-filter?
    agar user dapat menggunakan simbol untuk membuat password.
    ...
    */
    ...
    /*
    KENAPA :name, :username, :password, :email? 
